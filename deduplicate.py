...
class DupeDir(DupeFile):
    ...
    def keep(self, accum, delete_lookup, reviewed, dwd):
        ...
        if len(keeps) > 0:
            ...
            if dd:
                dd.keep(accum, delete_lookup, reviewed, dwd)
...
class DirectoryComparator:
    ...
    def analyze(self):
        ...
        d.keep(final_output, delete_lookup, reviewed, dirs_w_dupes)
